...
class FairseqTask(object):
    ...
    def inference_step2(
        self, generator, models, sample, prefix_tokens=None, attn_len=None, constraints=None
    ):
        
        with torch.no_grad():
            return generator.generate2(
                models, sample, prefix_tokens=prefix_tokens, attn_len=attn_len, constraints=constraints
            )
